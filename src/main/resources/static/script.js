	...
	sendForSimulation = function(){
		...
		$.ajax({
		    ...
		    success: function(){
		      ...
		      window.open("http://newdelhi.centralindia.cloudapp.azure.com:8080/ggraph.html");
	...
	sendForWeightSimulation = function(){
		...
		$.ajax({
		    ...
		    success: function(){
		      ...
		      $(".loader").css("visibility","hidden");
		      window.setTimeout(timeout, 6000);
		      window.open("http://http://newdelhi.centralindia.cloudapp.azure.com:8080/ggraph.html");
		      $(".instruction").css("display","block");
		    }
		});
	}
